# Banded Age Model (BAM) computational core, by Maud Comboul.
# Moved here from geoChronR so downstream packages (actR, compositeR) can
# simulate age ensembles without geoChronR's heavy age-modeling dependencies.
# The LiPD-level wrapper runBam() remains in geoChronR.
