...
nael$description <- "composite age ensemble created by ens::concatEnsembleTimeseries()"
...
npdl$description <- "composite paleo ensemble created by ens::concatEnsembleTimeseries()"
