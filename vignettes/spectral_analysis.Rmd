...
library(ens) # ensemble analysis (split out of geoChronR)
...
L <- ens::mapAgeEnsembleToPaleoData(I,paleo.meas.table.num = 1,age.var = "age")
age = ens::selectData(L,"ageEnsemble",meas.table.num = 1)
temp = ens::selectData(L,"temp muller",meas.table.num = 1)
